...
public class MainController implements Initializable {
	...
	/**
	 * Cause by click on newGameButton.
	 * New game method which: 
	 * - Reset all the imageViews
	 * - draw which player will start
	 * - pass to the nextTurn() method
	 */
	...
	/**
	 * Cause by click on imageView.
	 * Method set an Image and Disable imageView set as an parameter.
	 * At the end it pass to the nextTurn() method.
	 * @param iv
	 */
	...
	/**
	 * After every click on imageView method change the turnImageView and
	 * setStatus so it can calls which turn is it now. Every time it check
	 * if game is end, so it calls isWon() method.
	 */
	...
	/**
	 * If three same images are in the same rows, columns or diagonally method end
	 * game. It disabled all the images and show info and image of the winner at turnImageView.
	 * If there is no image available to click, method calls a draw.
	 * Also it checks if those images are not empty.
	 */
	private void isWon() {
		Boolean won = false;
